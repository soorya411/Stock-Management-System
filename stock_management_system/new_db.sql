...
MySQL - 8.0.22 : Database - stockmng
*********************************************************************
*/
...
(1,'contenttypes','0001_initial','2023-05-05 21:13:43.347446'),
(2,'auth','0001_initial','2023-05-05 21:14:16.453475'),
(3,'admin','0001_initial','2023-05-05 21:14:29.590412'),
(4,'admin','0002_logentry_remove_auto_add','2023-05-05 21:14:29.777623'),
(5,'admin','0003_logentry_add_action_flag_choices','2023-05-05 21:14:29.974384'),
(6,'contenttypes','0002_remove_content_type_name','2023-05-05 21:14:34.085150'),
(7,'auth','0002_alter_permission_name_max_length','2023-05-05 21:14:38.110144'),
(8,'auth','0003_alter_user_email_max_length','2023-05-05 21:14:39.091223'),
(9,'auth','0004_alter_user_username_opts','2023-05-05 21:14:39.421296'),
(10,'auth','0005_alter_user_last_login_null','2023-05-05 21:14:45.360869'),
(11,'auth','0006_require_contenttypes_0002','2023-05-05 21:14:45.460628'),
(12,'auth','0007_alter_validators_add_error_messages','2023-05-05 21:14:45.586646'),
(13,'auth','0008_alter_user_username_max_length','2023-05-05 21:14:50.756685'),
(14,'auth','0009_alter_user_last_name_max_length','2023-05-05 21:14:53.506160'),
(15,'auth','0010_alter_group_name_max_length','2023-05-05 21:14:54.489121'),
(16,'auth','0011_update_proxy_permissions','2023-05-05 21:14:54.596857'),
(17,'auth','0012_alter_user_first_name_max_length','2023-05-05 21:14:57.710707'),
(18,'sessions','0001_initial','2023-05-05 21:14:59.755137'),
(19,'sms','0001_initial','2023-05-05 21:16:08.893986'),
(20,'sms','0002_order_amt','2023-05-05 23:51:36.602297');
...
('6md6ekxt7egiasezkflhdp2jwimr3gt2','.eJyrVsrJTFGyMtJRKihKSS6BsUG0oY5SSX6JkpWxgYGOUlJmTk48VDYfRJvoKOUl5qYqWSk5OjkrpGQWlxRlJpWW5Bcp6SgVQ2WCc4sySzIylUCGg_QY1wIALoQhtw:1pvQzZ:pD6ode5-qLXaV5eTzcL3EmrapfXWBpldNIYcRElIYAk','2023-05-20 23:07:05.408868');
...
insert  into `sms_bill`(`id`,`date`,`total_amount`,`status`,`sid_id`) values 
(1,'2023-05-05',300,'paid',1),
(2,'2023-05-06',300,'paid',1);
...
CREATE TABLE `sms_billdetails` (
  ...
  KEY `sms_billdetails_pid_id_22504d26_fk_sms_order_id` (`pid_id`),
  CONSTRAINT `sms_billdetails_bid_id_1658cc88_fk_sms_bill_id` FOREIGN KEY (`bid_id`) REFERENCES `sms_bill` (`id`),
  CONSTRAINT `sms_billdetails_pid_id_22504d26_fk_sms_order_id` FOREIGN KEY (`pid_id`) REFERENCES `sms_order` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

/*Data for the table `sms_billdetails` */

insert  into `sms_billdetails`(`id`,`quantity`,`status`,`bid_id`,`pid_id`) values 
(1,'2','ordered',1,1),
(2,'2','ordered',2,1);
...
(1,'Bakery products','5','chips,cake'),
(2,'Milk  products','5','curd,lassi,butter milk'),
(3,'Icecream product','6','all flavours');
...
(1,'2023-05-06','delay','pending',1,2);
...
(1,'ABC distributor','Kuttipuram',9993246571,'abc@gmail.com','feedbackpage.JPG',4),
(2,'DK Distributors','Edappal',8976543210,'dk@gmail.com','feedbackpage_BYOKEEv.JPG',5);
...
(1,'nice service','2023-05-05',1),
(2,'good experience','2023-05-06',1),
(3,'nice service','2023-05-06',1);
...
(1,'admin','admin','admin'),
(2,'smrithi','smi123','shopowner'),
(3,'aak@tirur','aak@tirur','shopowner'),
(4,'abc@kuttipuram','abc@123','distributor'),
(5,'dk@edappal','dk@edappal','distributor');
...
insert  into `sms_order`(`id`,`date`,`orderstatus`,`stock`,`pid_id`,`sid_id`,`amt`) values 
(1,'2023-05-05','accept','16',1,1,'0'),
(2,'2023-05-05','accept','10',3,1,'2120'),
(3,'2023-05-05','pending','25',2,2,'0'),
(4,'2023-05-06','accept','10',3,1,'2120'),
(5,'2023-05-06','accept','11',3,1,'3500');
...
(1,'Parle Hide & Seek 4 Fun Flavours Choco Chip Creme Sandwich Biscuits ','400 g',110,150,50,'bishide.jpg',1,2),
(2,'Mom\'s Magic Rich Cashew Almond Cookies','600g',100,130,25,'moms.jpg',1,2),
(3,'Amul Chocolate Ice Cream Brownie','1l',800,230,200,'amul.webp',3,1);
...
(1,'Smrithi','Valanchery','smrithi@gmail.com',9845231277,'loginpage.JPG',2),
(2,'AAK Store','Tirur','aaktrr@gmail.com',9987654321,'homepage_XEPoiXZ.JPG',3);
